...
class App(Tk):
  def __init__(self):
    ...
    self.credit.grid(row=0, column=0, sticky="nsew")
    self.x44 = Register(container=self, name="x44")
    self.x44.grid(row=1, column=0, sticky="nsew")
    self.x54 = Register(container=self, name="x54")
    self.x54.grid(row=2, column=0, sticky="nsew")
    self.dump = Dump(container=self)
    self.dump.grid(row=3, column=0, sticky="nsew")
